...
? rawScores
: Array.from({length:18}, (*,i) => rawScores?.[i] ?? null);
return {
…m,
scores,
...
grossP1a: fbMatch.grossP1a ? Array.from({length:18},(*,i)=>fbMatch.grossP1a[i]??null) : null,
grossP1b: fbMatch.grossP1b ? Array.from({length:18},(*,i)=>fbMatch.grossP1b[i]??null) : null,
grossP2a: fbMatch.grossP2a ? Array.from({length:18},(*,i)=>fbMatch.grossP2a[i]??null) : null,
