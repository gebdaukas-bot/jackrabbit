  ...
  const Row = ({ label, field, color }) => (
    <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"10px 0",borderBottom:`1px solid ${BORDER}`}}>
      ...
      <div style={{display:"flex",alignItems:"center"}}>
        ...
        <div style={{width:44,height:34,background:BG,border:`1px solid ${BORDER}`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:16,fontWeight:900,color:GOLD,fontFamily:"monospace"}}>{vals[field]<0?`+${Math.abs(vals[field])}`:vals[field]}</div>
